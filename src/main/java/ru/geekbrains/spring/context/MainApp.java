...
//            System.out.println(cart.show() + "\n");
            ...
            System.out.println("Введите ID товара (первое поле класса Product: 1,2,3,4,5 или новое");
            int id = scanner.nextInt();
            cart.remove(id);
        }
...
//        System.out.println(cart.calculateTotalPrice());
    ...
    public static void intro(){
        ...
        System.out.println("    Перезапуск после каждого действия");
        ...
        System.out.println("Удалить товар по ID - нажмите 3\n");
        System.out.println("Сейчас в корзине 5 элементов:");
    }
}
